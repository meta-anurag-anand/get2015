 ...
 * Description: This Contains the Logic of puzzle
 **/
public class Puzzle 
{
	...
	// Cheeks whether the Puzzle is solvable or not
	 ...
	 * @param array
	 * @return
	 * Description: get the solution for the above problem
	 **/
	 ...
	 * @param number
	 * @return
	 * Description: Gets the distance between current and goal position
	 **/
	 ...
	 * Name: addtoQueue
	 * @param nextState
	 * Description: Adds to the Queue and traverse to next elemnt
	 **/
	...
	/**
	 * Name: solve
	 * Description: solves the problem Acording to the given specifications
	 **/
	public void solve() 
	{
