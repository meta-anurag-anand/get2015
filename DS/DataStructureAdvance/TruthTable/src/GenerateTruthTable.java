 ...
 * Description: Generate the Table for the required infix 
 **/
public class GenerateTruthTable 
{
	 ...
	 * @param input
	 * @return
	 * Description: Generate the table for input
	 **/
	 ...
	 * Description: Method to furnish the input expression i.e. this method will remove pairs of '~' symbols from expression
	 **/
	 ...
	 * @param inputPostfix
	 * @return letterSet 
	 * Description: Method to count letters in the given expression
	 **/
	 ...
	 * Name: evalPostfix
	 * @param inputPostfix
	 * Description: Evaluates the Postfix
	 **/
	...
	/**
	 * Name: OperationPerform
	 * @param characterFirst
	 * @param characterSecond
	 * @param op
	 * @return
	 * Description: Checks the String and performs the Operation
	 **/
	...
	/**
	 * Name:postfixConverter
	 * @param input
	 * @return
	 * Description: Converts into postfix Converter
	 **/
	...
	/**
	 * Name: binaryCombinations
	 * @param numberOfCharacters
	 * @return character Array corresponding to binary combinations
	 * Description: Method to find binary combination for a given number
	 **/
